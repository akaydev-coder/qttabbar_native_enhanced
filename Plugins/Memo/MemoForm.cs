...
namespace QuizoPlugins {
    internal sealed class MemoForm : Form {
        ...
        private void InitializeComponent() {
            ...
            colorToolStripMenuItem.Text = "Farbe";
            defaultToolStripMenuItem.Size = new Size(0x7f, 0x16);
            defaultToolStripMenuItem.Text = "Standardfarbe";
            defaultFontToolStripMenuItem.Size = new Size(0x7f, 0x16);
            defaultFontToolStripMenuItem.Text = "Standardschrift";
            ...
            columnHeader1.Text = "Pfad";
            columnHeader1.Width = 0x5d;
            columnHeader2.Text = "Notiz";
