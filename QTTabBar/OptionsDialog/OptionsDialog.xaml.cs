...
namespace QTTabBarLib {
    ...
    internal partial class OptionsDialog : Window {
        ...
        public static void ForceClose() {
            ...
            if(dialog != null && !dialog.Dispatcher.HasShutdownStarted) {
        ...
        private static void ThreadEntry() {
            ...
            try {
                ...
                if (dialog.lstCategories != null && dialog.WorkingConfig != null) {
                    dialog.lstCategories.SelectedIndex = dialog.WorkingConfig.desktop.lstSelectedIndex;
                }
                ...
                lock(instanceSync) {
                    ...
                    if(instanceThread == Thread.CurrentThread) {
                        instanceThread = null;
                    }
                }
            }
        ...
        private OptionsDialog() {
            try {
                ...
                WpfResourceLoader.LoadComponent(this, "optionsdialog/optionsdialog.xaml");
                ...
                Version assemblyVersion = typeof(OptionsDialog).Assembly.GetName().Version;
                this.Title = string.Format("{0} {1} Stable", this.Title.Trim(), assemblyVersion);
