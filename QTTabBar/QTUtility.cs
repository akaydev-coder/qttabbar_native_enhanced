...
namespace QTTabBarLib {
    internal static class QTUtility {
        ...
        internal static readonly Version CurrentVersion = new Version(1, 5, 93, 0);
        ...
        internal const bool IS_DEV_VERSION = false;
       ...
       // internal static Font StartUpTabFont;
        ...
        private static readonly object EmbeddedAssemblySync = new object();
        ...
        static QTUtility() {
            ...
            AppDomain.CurrentDomain.AssemblyResolve += (sender, args) => {
                ...
                if(string.Equals(owner.GetName().Name, shortName, StringComparison.OrdinalIgnoreCase)) {
                    return owner;
                }

                lock(EmbeddedAssemblySync) {
                    Assembly already = Array.Find(AppDomain.CurrentDomain.GetAssemblies(),
                        a => string.Equals(a.FullName, args.Name, StringComparison.OrdinalIgnoreCase));
                    if(already == null) {
                        already = Array.Find(AppDomain.CurrentDomain.GetAssemblies(),
        ...
        public static object ByteArrayToObject(byte[] arrBytes) {
            if (arrBytes != null && arrBytes.Length > 0)
            {
                ...
                {
                    QTUtility2.MakeErrorLog(exception, "ByteArrayToObject length:" + arrBytes.Length);
                }
            }
            return null;
        }
